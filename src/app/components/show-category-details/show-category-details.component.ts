...
export class ShowCategoryDetailsComponent {
   ...
   getTodosFromCategories(){
     ...
     this.categoryname && this.todo.getTodosFromCategory(this.categoryname).subscribe(
        ...
        result=>{
          ...
          if(this.allTodosOfCategory.length===0){
            this.showWelcomeMsg = true;
          }else if(this.allTodosOfCategory.length !== 0){
            this.showMainContainer = true;
          }
          ...
          } else if(this.pageSlice !== 0 && this.showWelcomeMsg){
