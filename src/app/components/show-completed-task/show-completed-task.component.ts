...
@Component({
  selector: 'app-show-completed-task',
  templateUrl: './show-completed-task.component.html',
  styleUrls: ['./show-completed-task.component.css']
})
export class ShowCompletedTaskComponent {
